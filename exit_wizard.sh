...
adb shell pm enable com.libremobileos.setupwizard/com.libremobileos.setupwizard.FinishActivity || true
if [[ ! -z "$has_google_suw" ]]
then
    wait ${!}
...
sleep 1
adb shell am start com.libremobileos.setupwizard/com.libremobileos.setupwizard.FinishActivity || true
if [[ ! -z "$has_google_suw" ]]
then
    wait ${!}
    sleep 1
